...
<head>
    ...
    <link rel="stylesheet" href="./app/Public/CSS/style.min.css">
</head>
    ...
    <header id="top-content">
        <div class="title-header container">
            ...
            if(isset($_SESSION['nickname'])){
                if($_SESSION['role'] == 1){ ?>
                    <p><a href="index.php" title="dirige vers la page d'accueil du site"><img class="logo" src="./app/Public/front/images/logobis.png" alt="logo 1001 pattes">Votre espace admin</a></p>
                <?php }
                elseif($_SESSION['role'] == 0){ ?>
                    <p><a href="index.php" title="dirige vers la page d'accueil du site"><img class="logo" src="./app/Public/front/images/logobis.png" alt="logo 1001 pattes">Refuge 1000 et Une Pattes</a></p>
                <?php }
            }
            else { ?>
                <p><a href="index.php" title="dirige vers la page d'accueil du site"><img class="logo" src="./app/Public/front/images/logobis.png" alt="logo 1001 pattes">Refuge 1000 et Une Pattes</a></p>
        ...
        <div class="banner container">
            <nav class="menu-principal">     
                ...
                <ul id="liste-nav">
                    <li><a class="active" href="index.php" title="dirige vers la page d'accueil du site">Accueil</a></li>
